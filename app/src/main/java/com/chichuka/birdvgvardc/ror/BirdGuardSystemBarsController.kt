package com.chichuka.birdvgvardc.ror
...
class TownPlannerSystemBarsController(private val activity: Activity) {
...
fun Activity.chickenSetupSystemBars() {
    TownPlannerSystemBarsController(this).chickenSetupSystemBars()
}
